  ...
  return (
    ...
    <div className="flex">
      ...
      <p>
        ...
        Karate squad at age 15, to training in Thai Boxing, Brazilian Jujitsu
        (BJJ) and Boxing. ​
      </p>
      <p>
        I specialize in Functional Movements with basic Pilates and incorporate
        fat burning, strength training, core stability, Calisthenics (body
        weight training), circuit training and padwork into my client’s
        workouts. ​{" "}
      </p>
      <p>
        I'm also trained in Thai Massage and Sports Massage which helps to
        relieve physical and emotional tension, improves sleep and flexibility
        and creates greater awareness of body and mind, releasing blocked
        energy.
      </p>
      <div>
        <div>
          ...
          <p>
            ...
            weaknesses with fitness assessments. These fitness assessments may
            also be performed before and after an exercise program to measure
            client's improvements in physical fitness. I also educate clients in
            many other aspects of wellness besides exercise, including general
        ...
        <div>
          ...
          <p>
            ...
            strenuous physical activity and trauma. The application of sports
            massage, prior to and after exercise, may enhance performance, aid
